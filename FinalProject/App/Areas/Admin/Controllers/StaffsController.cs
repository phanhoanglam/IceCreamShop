...
namespace App.Areas.Admin.Controllers
{
    ...
    public class StaffsController : Controller
    {
        ...
        // GET: Admin/Staffs
        [HasCredential(Permission = "staff_view")]
        ...
        public ActionResult Login(LoginViewModel viewModel, string returnUrl)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    var permissionKey = staff.Level.Permissions.Select(x => x.Key).ToList();
                    Session.Add(CommonConstants.PERMISSION, permissionKey);
                    Session["Staff"] = staff;
        ...
        [HasCredential(Permission = "staff_create")]
        ...
        [HasCredential(Permission = "staff_update")]
        ...
        [HasCredential(Permission = "staff_delete")]
